...
router.get('/', auth_middleware_1.authenticate, (0, rbac_middleware_1.requirePermission)('trainers.read'), [
...
router.get('/:id', auth_middleware_1.authenticate, (0, rbac_middleware_1.requirePermission)('trainers.read'), [
...
router.post('/', auth_middleware_1.authenticate, (0, rbac_middleware_1.requirePermission)('trainers.create'), [
...
router.patch('/:id/status', auth_middleware_1.authenticate, (0, rbac_middleware_1.requirePermission)('trainers.update'), [
    (0, express_validator_1.param)('id').isUUID().withMessage('Invalid match ID'),
...
router.delete('/:id', auth_middleware_1.authenticate, (0, rbac_middleware_1.requirePermission)('trainers.delete'), [
    (0, express_validator_1.param)('id').isUUID().withMessage('Invalid match ID')
