...
router.post('/register', [
    ...
    (0, express_validator_1.body)('gymId').isUUID().withMessage('Valid gym ID is required'),
    (0, express_validator_1.body)('roleId').isUUID().withMessage('Valid role ID is required'),
    validate,
...
router.post('/refresh', [
    ...
    validate,
], authMiddleware.authenticate, authController.refreshAccessToken);
