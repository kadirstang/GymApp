...
export declare const getUsers: (req: Request, _res: Response, next: NextFunction) => Promise<void>;
...
export declare const updateUserMeasurement: (req: Request, _res: Response, next: NextFunction) => Promise<void>;
export declare const deleteUserMeasurement: (req: Request, _res: Response, next: NextFunction) => Promise<void>;
